...
function animate( ) {
    ...
    // ISS ROTATION
    const issRotation = (( delta * Math.PI * 2 ) / .025) / 100; // Slowed down 100 times
    if (iss) iss.rotation.y += issRotation;
    issGroup.rotation.y += issRotation;
...
issGroup.position.set( 900, 0, 500 );
